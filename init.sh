...
cp /mingw64/bin/libsfml-audio-2.dll .
cp /mingw64/bin/libsfml-system-2.dll .
cp /mingw64/bin/libssp-0.dll .
cp /mingw64/bin/libvorbis-0.dll .
cp /mingw64/bin/libvorbisenc-2.dll .  
cp /mingw64/bin/libvorbisfile-3.dll . 
cp /mingw64/bin/libwinpthread-1.dll . 
cp /mingw64/bin/libz3.dll . 
