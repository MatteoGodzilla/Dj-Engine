#line 1 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.cpp"
...
#line 67 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.cpp"

#line 1 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 1 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imconfig.h"
...
#line 36 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
#line 37 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 14 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.18362.0\\ucrt\\float.h"
...
#line 43 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
#line 1 "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Community\\VC\\Tools\\MSVC\\14.23.28105\\include\\stdarg.h"
...
#line 44 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 45 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 46 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 59 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"


#line 62 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 66 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"

#line 68 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"



#line 72 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"


#line 75 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"




#line 80 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"

#line 82 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 91 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"



#line 95 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 130 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 177 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
struct ImVec2
{
    ...
    float  operator[] (size_t idx) const { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(184)), 0) ); return (&x)[idx]; }    
    float& operator[] (size_t idx)       { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(185)), 0) ); return (&x)[idx]; }    
...
namespace ImGui
{
     ...
     bool          DragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", const char* format_max = 0, float power = 1.0f);
     ...
     bool          DragIntRange2(const char* label, int* v_current_min, int* v_current_max, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d", const char* format_max = 0);
     bool          DragScalar(const char* label, ImGuiDataType data_type, void* v, float v_speed, const void* v_min = 0, const void* v_max = 0, const char* format = 0, float power = 1.0f);
     bool          DragScalarN(const char* label, ImGuiDataType data_type, void* v, int components, float v_speed, const void* v_min = 0, const void* v_max = 0, const char* format = 0, float power = 1.0f);
     ...
     bool          SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = 0, float power = 1.0f);
     bool          SliderScalarN(const char* label, ImGuiDataType data_type, void* v, int components, const void* v_min, const void* v_max, const char* format = 0, float power = 1.0f);
     ...
     bool          VSliderScalar(const char* label, const ImVec2& size, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = 0, float power = 1.0f);
     ...
     bool          InputScalar(const char* label, ImGuiDataType data_type, void* v, const void* step = 0, const void* step_fast = 0, const char* format = 0, ImGuiInputTextFlags flags = 0);
     bool          InputScalarN(const char* label, ImGuiDataType data_type, void* v, int components, const void* step = 0, const void* step_fast = 0, const char* format = 0, ImGuiInputTextFlags flags = 0);
...
#line 804 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
#line 1084 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
#line 1122 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
#line 1167 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
#line 1188 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
struct ImVector
{
    ...
    inline T&           operator[](int i)                   { (void)( (!!(i < Size)) || (_wassert(L"i < Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1248)), 0) ); return Data[i]; }
    inline const T&     operator[](int i) const             { (void)( (!!(i < Size)) || (_wassert(L"i < Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1249)), 0) ); return Data[i]; }
    ...
    inline T&           front()                             { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1256)), 0) ); return Data[0]; }
    inline const T&     front() const                       { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1257)), 0) ); return Data[0]; }
    inline T&           back()                              { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1258)), 0) ); return Data[Size - 1]; }
    inline const T&     back() const                        { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1259)), 0) ); return Data[Size - 1]; }
    ...
    inline void         pop_back()                          { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1269)), 0) ); Size--; }
    inline void         push_front(const T& v)              { if (Size == 0) push_back(v); else insert(Data, v); }
    inline T*           erase(const T* it)                  { (void)( (!!(it >= Data && it < Data+Size)) || (_wassert(L"it >= Data && it < Data+Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1271)), 0) ); const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + 1, ((size_t)Size - (size_t)off - 1) * sizeof(T)); Size--; return Data + off; }
    inline T*           erase(const T* it, const T* it_last){ (void)( (!!(it >= Data && it < Data+Size && it_last > it && it_last <= Data+Size)) || (_wassert(L"it >= Data && it < Data+Size && it_last > it && it_last <= Data+Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1272)), 0) ); const ptrdiff_t count = it_last - it; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + count, ((size_t)Size - (size_t)off - count) * sizeof(T)); Size -= (int)count; return Data + off; }
    inline T*           erase_unsorted(const T* it)         { (void)( (!!(it >= Data && it < Data+Size)) || (_wassert(L"it >= Data && it < Data+Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1273)), 0) );  const ptrdiff_t off = it - Data; if (it < Data+Size-1) memcpy(Data + off, Data + Size - 1, sizeof(T)); Size--; return Data + off; }
    inline T*           insert(const T* it, const T& v)     { (void)( (!!(it >= Data && it <= Data+Size)) || (_wassert(L"it >= Data && it <= Data+Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1274)), 0) ); const ptrdiff_t off = it - Data; if (Size == Capacity) reserve(_grow_capacity(Size + 1)); if (off < (int)Size) memmove(Data + off + 1, Data + off, ((size_t)Size - (size_t)off) * sizeof(T)); memcpy(&Data[off], &v, sizeof(v)); Size++; return Data + off; }
    ...
    inline int          index_from_ptr(const T* it) const   { (void)( (!!(it >= Data && it <= Data+Size)) || (_wassert(L"it >= Data && it <= Data+Size", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1280)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
...
#line 1404 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
namespace ImGui
{
    ...
    static inline ImVec2 CalcItemRectClosestPoint(const ImVec2& pos, bool on_edge = false, float outward = 0.f) { ((void)on_edge); ((void)outward); (void)( (!!(0)) || (_wassert(L"0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1568)), 0) ); return pos; }
...
#line 1584 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
struct ImGuiTextBuffer
{
    ...
    ImGuiTextBuffer()   { }
    inline char         operator[](int i)       { (void)( (!!(Buf.Data != 0)) || (_wassert(L"Buf.Data != 0", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1632)), 0) ); return Buf.Data[i]; }
...
struct ImGuiListClipper
{
    ...
    ~ImGuiListClipper()                                                 { (void)( (!!(ItemsCount == -1)) || (_wassert(L"ItemsCount == -1", L"C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h", (unsigned)(1719)), 0) ); }      
...
#line 1740 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 1781 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
struct ImDrawCmd
{
    ...
    ImDrawCmd() { ElemCount = 0; TextureId = (ImTextureID)0; VtxOffset = IdxOffset = 0;  UserCallback = 0; UserCallbackData = 0; }
};
...
#line 1810 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
#line 1826 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
...
struct ImFontGlyphRangesBuilder
{
    ...
    inline void     SetBit(int n)       { int off = (n >> 5); ImU32 mask = 1u << (n & 31); UsedChars[off] |= mask; }               
...
struct ImFontAtlasCustomRect
{
    ...
    ImVec2          GlyphOffset;    
    ImFont*         Font;           
    ImFontAtlasCustomRect()         { ID = 0xFFFFFFFF; Width = Height = 0; X = Y = 0xFFFF; GlyphAdvanceX = 0.0f; GlyphOffset = ImVec2(0,0); Font = 0; }
...
struct ImFontAtlas
{
    ...
    bool                        IsBuilt()                   { return Fonts.Size > 0 && (TexPixelsAlpha8 != 0 || TexPixelsRGBA32 != 0); }
    ...
    const ImFontAtlasCustomRect*GetCustomRectByIndex(int index) const { if (index < 0) return 0; return &CustomRects[index]; }

    
     void              CalcCustomRectUV(const ImFontAtlasCustomRect* rect, ImVec2* out_uv_min, ImVec2* out_uv_max);
...
#line 2176 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};
...
#line 2231 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"
};



#line 2236 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"

#line 2238 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui.h"





#line 69 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.cpp"
#line 1 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.h"
...
#line 54 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.h"

#line 56 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.h"

#line 58 "C:\\Users\\caten\\Dj-Engine\\lib\\IMGUI\\imgui_impl_opengl3.h"
